...
//    analogWrite(Drive_pwm, (0-255));
  ...
  easing_drive = 100;          //modify this value for sensitivity (1000)
  easing_drive /= 100;
  ...
  } else pitchOffset = pitchOffset;

// #ifdef IMUFilter
// float imuFeedback = /* Read IMU data (gyroscope or accelerometer) */;
// float IMUFiltered = 0; // Initialize filtered value

// if (receiveIMUData.pitch > IMUDeadzone) {
//     filteredValue = 0.06;
// } else if (imuFeedback < -0.06) {
//     filteredValue = -0.06;
// } else {
//     filteredValue = imuFeedback;
// }
