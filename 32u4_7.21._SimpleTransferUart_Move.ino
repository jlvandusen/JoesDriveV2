...
//#define S2SPot_pin A0 // Moved to ESP32
//#define bodyNeoPixels_Pin A4  // Moved to ESP32
#define leftServoPin 12 //12
#define rightServoPin 11 //11
...
void encoder() {
...
#ifdef MOVECONTROLLER_ESP32
  if (receiveFromM0Data.moveR3 && moveR3Was == false){
    xboxR3Was = true;
    myEnc.write(encPos - 1497/2);
    
  } else if(receiveFromM0Data.moveR3 == false && moveR3Was == true){
    moveR3Was = false;
    myEnc.write(encPos + 1497/2);
  ...
  if(receiveFromM0Data.moveL3 == 1 && r3Flag == false){
    r3Flag = true; 
    domeServoMode = !domeServoMode; 
    
  }else if(receiveFromM0Data.moveL3 == 0 && r3Flag == true){
    r3Flag = false; 
  }
#endif
