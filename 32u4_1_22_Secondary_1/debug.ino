void debugRoutines(){
    ...
    SerialDebug.print(F("enableDrive: ")); Serial.print(enableDrive); SerialDebug.println('\t');
     ...
     SerialDebug.print(F("driveEnabled: ")); Serial.print(receiveFromESP32Data.driveEnabled); Serial.print("\t"); 
...
//     SerialDebug.print(F("flywheel: ")); Serial.print(receiveFromESP32Data.flywheel); Serial.print("\t"); 
     ...
     SerialDebug.print(F("soundcmd;: ")); Serial.print(receiveFromESP32Data.soundcmd); Serial.print("\t"); 
     SerialDebug.print(F("psiFlash: ")); Serial.print(receiveFromESP32Data.psiFlash); Serial.print("\t"); 
     SerialDebug.print(F("pitch: ")); Serial.print(receiveFromESP32Data.pitch); Serial.print("\t"); 
     SerialDebug.print(F("roll: ")); Serial.print(receiveFromESP32Data.roll); SerialDebug.println('\t');
